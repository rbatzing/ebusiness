...
| Roles | | Belbin Types | |
|:------------------|:---------------:|:------:|:------:|
|Action-oriented: | Shaper  (2.3%) | Implementer  (11.4%)  | Completer Finisher (3.6%)|
|People-oriented: | Co-ordinator (26.2%) | Teamworker (18.2%) | Resource Investigator (33.2%) |
|Thinking-oriented: | Plant (3.7%) |Monitor  Evaluator (0.5%) | Specialist (0.8%) |
...
This exercise was adapted from a 2017 Kaggle Competition [@Kaggle2017]
</div>\EndKnitrBlock{rmdexercise}
