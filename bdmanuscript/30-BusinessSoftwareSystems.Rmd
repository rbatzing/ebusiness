...
```{block2,st:onlinebank, type='rmdstudy'}
...
```{block2,ds:employeeads, type='rmddiscussion'}
...
**Product Review: OrangeHRM - Human Resource Management Web Site**
...
```{block2,ex:churn, type='rmdexercise'}
