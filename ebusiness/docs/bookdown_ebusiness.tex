...
\usepackage{graphicx}
\usepackage{float}
\usepackage[margin=1in, paperwidth=8.25in, paperheight=11in]{geometry}
\makeatletter
\def\thm@space@setup{%
...
%%%%%%%%
\floatstyle{ruled}
\newfloat{exercise}{htbp}{loe}[chapter]
\floatname{exercise}{Exercise}
\floatstyle{boxed}
\newfloat{extrastudy}{htbp}{los}[chapter]
\floatname{extrastudy}{Reading}
\newfloat{discussion}{htbp}{lot}[chapter]
...
\includegraphics{10-GeneralPrinciples_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\textbf{Three levels of Digital Intelligence Quotient:}

\begin{itemize}
\item
  Level 1: \textbf{Digital citizenship:} The ability to use digital technology and media in safe, responsible and effective ways
\item
  Level 2: \textbf{Digital creativity:} The ability to become a part of the digital ecosystem by co-creating new content and turning ideas into reality by using digital tools
\item
  Level 3: \textbf{Digital entrepreneurship:} The ability to use digital media and technologies to solve global challenges or to create new opportunities
\end{itemize}

\begin{figure}
\centering
\includegraphics{images/DQthai.png}
\caption{DQ Skills}
\end{figure}

\BeginKnitrBlock{rmdextra}
\textbf{Understanding and understanding of a child trained as a Digital Citizen}
