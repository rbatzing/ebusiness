...
X> ## Match the principles to market characteristics
X>
X> |  | Principle |   |Characteristics |
X> |---|-----------|---|--------------|
X> | 1. | Access to market |  ___ | Consumer preferance |
X> | 2. | Customers        |  ___ |Dependable supply of raw materials |
X> | 3. | Investment capital | ___ |Distinctive goods and services |
X> | 4. | Marketable goods and services | ___ | Investors and line of credit |
X> | 5. | Resources        | ___ | Right location |
X> | 6. | Value            | ___ | Steady market demand |
...
As organizations embrace the concept of open organizations they recognize thatopenness as a necessary orientation toward success and pursing openness in organizations can lead to 3 possessive outcomes:[^ambassador]
 
[^ambassador]: The Open Organization Ambassors, 2017. The Open Organization Definition. 2nd Edition. Available online at https://opensource.com/sites/default/files/gated-content/openorg_definition_ebook.pdf
...
![Core elements of open organization](images/openorg.png
...
* **Transparency:** Workers have access to all pertinent information and willingly disclose and discuss their work. People affected by decisions can access and review the processes and arguements that lead to the decision and are free to comment and respond to them. Successes and failures are both valued for the lessons they provide.
* **Inclusivity:** Protocols and procedures are in place to encourage constructive inclusion of diverse perspectives. Leaders are concious of voices not present in dialog and actively seek to include them. People work transparently and use technical standards to ensure and encourage access to discussion forums.
...
1. Word of mouth referrals from trusted acquaintance are powerful attractions.
2. Customer testimonials are decisive in purchasing decisions.
3. Community discussion of a product underdevelopment increases the 
