...
* **Modeling:** Simple visual model of the business process. This phase defines the individual roles and the business logic of the process.

* **Simulation:** Execute tasks generation according to measured performance data. This phase tests the model based on rates of service measured in the work place.

* **Analysis:** Creates a dashboard of performance indicators. This phase verifies the process design, identifies opportunities for process improvement, helps to maximize employee and resource utilization, and provides for performance-based estimates of cost.
